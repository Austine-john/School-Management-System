...
# Environment variables loaded from a .env file next to manage.py.
env = environ.Env(
    DEBUG=(bool, False),
    ALLOWED_HOSTS=(list, []),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': (
        'Multi-tenant REST API for a school management platform. '
        'Each school is isolated at the row level via the `school` field.'
    ),
    'VERSION': '1.0.0',
